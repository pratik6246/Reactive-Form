(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! D:\angular\Reactive Form\src\main.ts */
      "zUnb");
      /***/
    },
        ...
        _createClass(AppComponent, [{
          ...
          value: function ngOnInit() {
            this.registerForm = this.fb.group({
              ...
              phone: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(/[0-9]{10}/g)]],
          ...
          value: function submitForm() {
            ...
            console.log(this.formValues); // console.log(this.registerForm.value);
            ...
            if (this.add_form) {
              ...
              var dob_pass = this.registerForm.value.dob.split('-');
              var newId = "DOB_".concat(dob_pass[2]).concat(dob_pass[1]);
              console.log(newId);
              newUser.id = newId;
              this.registeredUsers.push(newUser);
            } else if (this.editedUser) {
              var userIndex = this.registeredUsers.findIndex(function (item) {
                return item.id === _this.editedUser.id;
              });
          ...
          key: "editUser",
          value: function editUser(_editUser, i) {
            this.add_form = false;
            console.log(_editUser);
            this.editedUser = _editUser;
            this.registerForm.patchValue({
              firstName: _editUser.firstName,
              lastName: _editUser.lastName,
              email: _editUser.email,
              phone: _editUser.phone,
              company: _editUser.company,
              gender: _editUser.gender,
              dob: _editUser.dob,
              password: _editUser.password,
              confirmPassword: _editUser.confirmPassword
            });
          }
        }, {
          key: "deleteUser",
          value: function deleteUser(user) {
            this.registeredUsers = this.registeredUsers.filter(function (item) {
          ...
          key: "changeVal1",
          value: function changeVal1(eve) {
            console.log(eve);
          }
        }, {
          key: "changeVal2",
          value: function changeVal2(eve) {
            console.log(eve);
          }
        }]);
